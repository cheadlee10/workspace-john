...
batch_path=root/'email-templates'/'next-queued-email-assets-2026-03-03-batch78.md'
...
for idx,lead_id in enumerate(missing, start=1):
    ...
    rec={
      ...
      'priority_tier':'P2',
      'priority_score':78,
      'template_asset_file':'next-queued-email-assets-2026-03-03-batch78.md',
      'asset_ready':True,
