...
# map lead ids to business names from section headers
...
for i,lid in enumerate(missing,1):
    ...
    o={
        ...
        'priority_tier':'P2',
        'priority_score':79,
        'template_asset_file':'next-queued-email-assets-2026-03-03-batch82.md',
        'asset_ready':True,
...
with csv_path.open('a',encoding='utf-8',newline='') as f:
    ...
    for o in new_objs:
        w.writerow({
            'timestamp':o['scheduled_at'],'batch_id':'BATCH-J-WAVE6','day':'1','channel':'email','lead_id':o['lead_id'],'business_name':o['business_name'],'template_id':'',
            ...
            'notes':'asset=next-queued-email-assets-2026-03-03-batch82.md;approval=pending_main_agent_approval;verification=pending_contact_enrichment'
        })
