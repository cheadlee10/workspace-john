...
wave = root / "sites" / "premium-v3-wave27"
wave.mkdir(parents=True, exist_ok=True)

# Highest-priority uncovered leads from outreach_queue.jsonl
selected_ids = [
    "gpass-us-374",  # Hiller Plumbing, Heating, Cooling & Electrical
    "gpass-us-377",  # Avidus Roofing
    "gpass-us-379",  # Fenwick Home Services
    "gpass-us-373",  # Precision Garage Door of San Antonio
    "gpass-us-380",  # The Roof Clinic
]
...
service_content = {
    ...
    "Garage Door Repair": {
        "headline_suffix": "Garage Door Repair & Spring Replacement Calls",
        "hero": "Premium conversion layout built for urgent garage-door failures and same-day repair inquiries with immediate click-to-call action.",
        "services": [
            "Broken spring and cable replacement",
            "Garage door opener troubleshooting and installs",
            "Track alignment, roller, and safety-sensor repairs",
            "Full door replacement and tune-up packages",
        ],
    },
    "HVAC/Plumbing/Electrical": {
        "headline_suffix": "Home Service Emergency & Upgrade Leads",
        "hero": "Premium multi-service conversion page tailored to capture HVAC, plumbing, and electrical requests from high-intent homeowners.",
        "services": [
            "24/7 emergency dispatch for core home systems",
            "HVAC tune-ups, diagnostics, and replacement planning",
            "Plumbing leak, drain, and water-heater service",
            "Electrical troubleshooting, panel upgrades, and safety fixes",
        ],
    },
}
...
notes += [
    ...
    "4. Three selected leads do not expose a public email in queue; page contact row uses `Email not publicly listed` to avoid fabricated placeholders.",
]
