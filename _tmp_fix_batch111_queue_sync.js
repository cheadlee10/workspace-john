...
const batchFile=path.join(cwd,'email-templates','next-queued-email-assets-2026-03-03-batch111.md');
...
let appendJsonl='';
let appendCsv='';
const start=new Date('2026-03-05T14:35:00-08:00');
const fmt=(d)=>{
  const local=new Date(d.getTime()-8*60*60*1000); // force -08:00 wall clock formatting
...
for(let i=0;i<missing.length;i++){
  ...
  const rec={
    ...
    priority_tier:'P2',
    priority_score:79,
    template_asset_file:'next-queued-email-assets-2026-03-03-batch111.md',
    asset_ready:true,
  ...
  appendCsv += [
    ...
    'P2',79,'next-queued-email-assets-2026-03-03-batch111.md',true,'pass:{{live_url}},{{screenshot_url}}',
