...
wave_dir=root/'sites'/'premium-v3-wave80'
email_file=root/'email-templates'/'next-queued-email-assets-2026-03-03-batch83.md'
...
# placeholder + claims checks per section
...
if missing:
    ...
    for i,lid in enumerate(missing,1):
        ...
        obj={
            ...
            'priority_tier':'P2',
            'priority_score':79,
            'template_asset_file':'next-queued-email-assets-2026-03-03-batch83.md',
            'asset_ready':True,
    ...
    with csv_path.open('a',encoding='utf-8',newline='') as f:
        ...
        for obj in new:
            w.writerow({
                ...
                'notes':'asset=next-queued-email-assets-2026-03-03-batch83.md;approval=pending_main_agent_approval;verification=pending_contact_enrichment'
            })
    appended=len(new)
