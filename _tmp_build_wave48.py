...
wave = root / 'sites' / 'premium-v3-wave48'
...
leads = [
    {
        ...
        'bullets': [
            'High-intent hero focused on curb appeal upgrades, irrigation fixes, and seasonal cleanups with a rapid estimate CTA',
            'Service blocks for lawn maintenance, desert-friendly planting, hardscaping accents, and one-time property refreshes',
            'Trust strip highlights established local reputation, photo-first proof, and clear service-area positioning',
            'Quote workflow captures property size, requested services, and project timing to prioritize ready-to-book homeowners',
        ],
    },
    {
        'id': 'NS005',
        ...
        'bullets': [
            'Conversion-first hero built around fast callbacks for mowing, cleanups, and landscape makeovers in Phoenix neighborhoods',
            'Offer stack emphasizes recurring service plans, one-time rescue jobs, and budget-matched upgrade options',
            'Authority section reinforces consistency, professionalism, and local service reliability for owner-occupied properties',
            'Form intake asks for yard condition, preferred schedule, and urgency to route high-intent quote requests quickly',
        ],
    },
    {
        'id': 'NS110',
        ...
        'phone': '(602) 769-4564',
        'service': 'Landscaping',
        'slug': 'divine-design-landscaping-phoenix-az',
        'bullets': [
            'Premium positioning hero tailored for established landscapers with high review volume and upscale outdoor project demand',
            'Service modules highlight design-forward installs, cleanup programs, lighting add-ons, and drought-smart planting plans',
            'Credibility band supports trust with review-driven messaging, insured workmanship, and transparent estimate process',
            'Detailed quote form captures project type, budget intent, and desired start date for faster close-ready follow-up',
        ],
    },
    {
        'id': 'NS004',
        ...
        'bullets': [
            'Lead-focused hero crafted for established Arizona landscaping operators targeting residential and HOA property work',
            'Service layout promotes maintenance, irrigation checks, decorative gravel installs, and yard transformation packages',
            'Trust messaging reinforces years in market, responsive communication, and clean handoff from estimate to scheduling',
            'Quote path collects service scope, lot details, and ideal appointment window to improve sales-call quality',
        ],
    },
    {
        'id': 'NS050',
        'business': 'One Pro Handyman 40 Years Exp',
        'city': 'Houston, TX',
        'phone': '(281) 000-0000',
        'service': 'Handyman/Roofing',
        'slug': 'one-pro-handyman-40-years-exp-houston-tx',
        'bullets': [
            'Trust-first hero spotlights decades of experience with immediate callback CTA for repairs, punch lists, and small roofing jobs',
            'Service stack covers drywall, trim, door fixes, leak patching, and general home maintenance with clear next steps',
            'Authority strip emphasizes veteran expertise, dependable workmanship, and broad suburban Houston service coverage',
            'Lead form captures repair type, property location, and urgency so top-value jobs receive fastest response',
        ],
    },
]
...
notes = """# Premium V3 Wave 48 Deployment Notes
