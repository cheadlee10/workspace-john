...
const batch='next-queued-email-assets-2026-03-03-batch71.md';
...
const qjPath=path.join(process.cwd(),'email-templates','send-queue-2026-03-02-next-batches.jsonl');
const qcPath=path.join(process.cwd(),'email-templates','send-queue-2026-03-02-next-batches-tracker.csv');
