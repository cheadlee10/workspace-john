...
const waveDir=path.join(cwd,'sites','premium-v3-wave112');
const batchFile=path.join(cwd,'email-templates','next-queued-email-assets-2026-03-03-batch115.md');
...
console.log(JSON.stringify({wave:'112',batch:'115',siteResults,emailIssues,ids,missingJsonl,missingCsv},null,2));