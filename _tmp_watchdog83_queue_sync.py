...
# newest queued leads = max gpass-us numeric ids among today's new records
cand=[]
for r in queue:
...
for rec in latest:
    ...
    if tr is None:
        ...
        index[tid]=tr
        t_changed+=1
    # sync schedule fields from queue
...
tracker['updated_at_local']='2026-03-03 14:00:00'
tracker['updated_by']='subagent-watchdog83-sendops-queueing'
tracker_path.write_text(json.dumps(tracker,indent=2)+'\n',encoding='utf-8')

# append markdown refresh note
append = """
...
if '## Watchdog83 refresh (14:00 PST)' not in text:
