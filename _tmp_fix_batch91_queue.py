...
batch_file = Path('email-templates/next-queued-email-assets-2026-03-03-batch91.md')
...
print(f'Appended {len(new_json_objs)} JSONL entries and up to {len(new_json_objs)} CSV rows for batch91.')