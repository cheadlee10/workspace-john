...
batch_file=root/'email-templates'/'next-queued-email-assets-2026-03-03-batch113.md'
...
# compute start time from latest scheduled_at in jsonl
last_dt=None
with jsonl_path.open(encoding='utf-8') as f:
    for line in f:
        line=line.strip()
...
asset='next-queued-email-assets-2026-03-03-batch113.md'
